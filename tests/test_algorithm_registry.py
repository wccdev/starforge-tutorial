...
def test_official_plugin_packages_are_valid():
    ...
    from starforge.plugins import LOAD_DEFERRED, LOAD_EAGER, load_manifest
...
def test_all_plugin_packages_in_repo_pass_validation():
    ...
    from starforge.plugins import directory_digest, load_manifest
...
def test_recipe_declared_plugins_all_exist():
    ...
    from starforge.recipes import all_recipes
